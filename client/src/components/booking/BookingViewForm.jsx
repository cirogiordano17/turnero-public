    ...
    <div className="client-form-card">
      <div className="booking-view-form">
        <div className="booking-view-form__top">
          <div className="booking-view-form__category-inline">
            <span className="booking-view-form__category-text">
        ...
        <div className="booking-view-form__section">
          ...
          <div className="booking-summary-box">
            ...
            <div className="booking-view-form__section">
              <h2 className="booking-view-form__section-title">Tus datos</h2>
